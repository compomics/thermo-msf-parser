...
<a href="http://genesis.ugent.be/maven2/com/compomics/thermo_msf_parser/thermo_msf_parser_GUI/2.0.5/thermo_msf_parser_GUI-2.0.5-archive.zip"><img src="https://github.com/compomics/thermo-msf-parser/wiki/images/download_button.png" alt="download" /></a>

| Download | Version | Release info |
| :--: |:--:| :--:|
| <a href="http://genesis.ugent.be/maven2/com/compomics/thermo_msf_parser/thermo_msf_parser_GUI/2.0.5/thermo_msf_parser_GUI-2.0.5-archive.zip" onclick="trackOutboundLink('http://www.example.com'); return false;"><img src="https://github.com/compomics/thermo-msf-parser/wiki/images/download_button.png" alt="download" /></a> | *2.0.5 - All platforms* |    [Release notes](https://github.com/compomics/thermo-msf-parser/wiki/ReleaseNotes) |
