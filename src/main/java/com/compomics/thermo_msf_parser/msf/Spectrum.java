...
public class Spectrum {
    ...
    public String getSpectrumTitle(){
        ...
        if(iFirstScan != iLastScan){
            return lRawFile + "_" + iUniqueSpectrumId + "_" + iFirstScan + "." + iLastScan + "_2_" + iCharge;
        } else {
            return lRawFile + "_" + iUniqueSpectrumId + "_" + iFirstScan + "_1_" + iCharge;
        }
    }
