...
import com.compomics.thermo_msf_parser_API.enums.PeptideFragmentIonType;
...
public class SpectrumPanel extends GraphicsPanel {
     ...
     */
    public static List<DefaultSpectrumAnnotation> filterAnnotations(
            List<DefaultSpectrumAnnotation> annotations,
        ...
        List<DefaultSpectrumAnnotation> filteredAnnotations = new ArrayList<DefaultSpectrumAnnotation>();
