...
public class Filter {
    ...
    /**
     * Vector with the parameter names
     */
    private Vector<String> iParameterName = new Vector<String>();
    /**
     * Vector with the parameter values
     */
    private Vector<String> iParameterValue = new Vector<String>();
    /**
     * The filter set name
     */
     ...
     */
    public Filter(String iFilterSetName, Vector<String> iFilterXmlLines) {
