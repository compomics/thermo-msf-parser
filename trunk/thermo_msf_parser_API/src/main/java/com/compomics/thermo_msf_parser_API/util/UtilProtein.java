...
/**
 * This class implements the behavior for a Protein instance.
...
public class UtilProtein {
    ...
    Logger logger = Logger.getLogger(UtilProtein.class);
     ...
     */
    public UtilProtein(AASequenceImpl aSequence) {
        this(null, aSequence);
    }
     ...
     */
    public UtilProtein(Header aHeader, AASequenceImpl aSequence) {
     ...
     */
    public UtilProtein(Header aHeader, AASequenceImpl aSequence, boolean aTruncated, int aTruncationPosition) {
     ...
     */
    public UtilProtein(String aFASTAString) {
     ...
     * @param   aTruncationPosition int with the coded position for the truncation (N-Term or C-Term).
     */
    public UtilProtein(String aFASTAString, boolean aTruncated, int aTruncationPosition) {
        try {
     ...
     */
    public UtilProtein(String aHeader, String aSequence) {
        this(aHeader, aSequence, false, 0);
    }
     ...
     * @param   aTruncationPosition int with the coded position for the truncation (N-Term or C-Term).
     */
    public UtilProtein(String aHeader, String aSequence, boolean aTruncated, int aTruncationPosition) {
     ...
     */
    public UtilProtein getNTermTruncatedProtein(int aSize) {
        ...
        return new UtilProtein(header, sequence, flag, UtilProtein.NTERMTRUNC);
    }
     ...
     */
    public UtilProtein getCTermTruncatedProtein(int aSize) {
        // First get the current sequence.
        AASequenceImpl sequence = this.getSequence();
        // Extract start and end locations.
        ...
        // Return the newly constructed Protein.
        return new UtilProtein(header, sequence, flag, UtilProtein.CTERMTRUNC);
    }
